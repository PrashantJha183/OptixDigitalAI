...
const SkeletonLoader = () => {
  return (
    <div className="p-4 max-w-6xl mx-auto space-y-6">
      {/* Heading placeholder */}
      <div className="relative overflow-hidden bg-gray-300 rounded h-12 w-3/4 mx-auto">
        <div className="absolute inset-0 bg-gradient-to-r from-gray-300 via-gray-200 to-gray-300 animate-shimmer"></div>
      </div>

      {/* Subheading */}
      <div className="relative overflow-hidden bg-gray-300 rounded h-8 w-1/2 mx-auto">
        <div className="absolute inset-0 bg-gradient-to-r from-gray-300 via-gray-200 to-gray-300 animate-shimmer"></div>
      </div>
      ...
      {/* Button placeholder */}
      <div className="relative overflow-hidden bg-gray-300 rounded h-10 w-40 mx-auto">
        <div className="absolute inset-0 bg-gradient-to-r from-gray-300 via-gray-200 to-gray-300 animate-shimmer"></div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
        {[...Array(3)].map((_, i) => (
          <div key={i} className="space-y-3">
            ...
            <div className="relative overflow-hidden bg-gray-300 rounded h-8 w-32">
              <div className="absolute inset-0 bg-gradient-to-r from-gray-300 via-gray-200 to-gray-300 animate-shimmer"></div>
            </div>
          </div>
        ))}
